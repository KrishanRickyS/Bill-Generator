...
<div class="page-content p-5" id="content">
  ...
  <!-- Demo content -->
  <h2 class="display-4 text-white text-center">BILL GENERATOR</h2>
  ...
  <div class="row text-white">
    <div class="col-lg-6">
      ...
      <p class="lead">This Bill Generator allows organizations to set up online bill management, consumers to read bills, and owners to save or download invoices for new businesses. In addition, you can use this bill generator to handle invoices in the system and to assist clients in creating, updating, and calculating bills/invoices without having to manually list them.</p>
...
<div class="mt-3">
	<img src="bill2.png" width="1000rem" height="auto" class="rounded mx-auto d-block" alt="...">
</div>
<!-- <div class="mt-5 text-center">
...
<div class="footer-copyright text-center text-light py-3 mt-5">Team 12 Cloud Project</div>
